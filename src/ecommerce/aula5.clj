...
;podemos fazer db/add com neste maps (aninhados)
...
; mas Diego, a categoria ja existe... tudo bem... lookup ref
...
(pprint (db/todos-os-noomes-de-produtos-e-categorias (d/db conn)))
